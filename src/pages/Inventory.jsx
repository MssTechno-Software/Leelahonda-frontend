                  ...
                  <tr className="bg-slate-50/50 border-b border-slate-100 text-[11px] font-bold text-slate-400 tracking-wider uppercase">
                    <th className="py-3 px-4 w-10">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            const paginatedIds = paginatedInventory.map((x) => x.id);
                            setSelectedIds((prev) =>
                    ...
                    paginatedInventory.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3.5 px-4 text-slate-500">{item.model}</td>
                          <td className="py-3.5 px-4 text-slate-500">{item.variant}</td>
                          <td className="py-3.5 px-4">
                            <div
                            ...
                            <div className="w-48 max-w-full">
                              {editingLocationId === item.id ? (
                                ...
                                >
                                  ...
                                  <div className="flex items-center gap-0.5 shrink-0 ml-1">
                                    <button
                                      type="button"
                                      onClick={() =>
                                        handleLocationSave(item.id, editingLocation)
                                      }
                                      disabled={savingLocation}
                                ...
                                <button
                                  ...
                                  className={`group flex items-center justify-between gap-2 h-9 px-3 rounded-lg border border-slate-200/80 bg-slate-50/70 text-slate-700 w-full transition-all duration-200 ${editingLocationId !== null &&
                                    editingLocationId !== item.id
                                    ? "opacity-40 cursor-not-allowed"
